...
public class SearchForUsers {
  ...
  @Test
  public void testSearchForUsers() throws Exception {
    driver.get(baseUrl + "");
    ...
    driver.findElement(By.linkText("Members List")).click();
    driver.findElement(By.name("search")).clear();
    driver.findElement(By.name("search")).sendKeys("jnapp18");
    driver.findElement(By.cssSelector("input[type=\"image\"]")).click();
    driver.findElement(By.name("search")).clear();
    driver.findElement(By.name("search")).sendKeys("jon18");
    driver.findElement(By.cssSelector("input[type=\"image\"]")).click();
    driver.findElement(By.linkText("jon18")).click();

...
public class EditUserSettings {
  ...
  @Test
  public void testEditUserSettings() throws Exception {
    driver.get(baseUrl + "");
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if ("My Profile".equals(driver.findElement(By.linkText("My Profile")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }

    driver.findElement(By.linkText("My Profile")).click();
    driver.get(baseUrl + "index.php?option=com_comprofiler&Itemid=24&task=userDetails");
